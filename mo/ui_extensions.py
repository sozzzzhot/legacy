...
from mo import extensions, shared, paths, config_states, errors, restart
from mo.paths_internal import config_states_dir
from mo.call_queue import wrap_gradio_gpu_call
    ...
    "Disable all extensions" was set, change it to "none" to load all extensions again
            ...
            with gr.TabItem("Available", id="available"):
                ...
                refresh_available_extensions_button.click(
                    fn=mo.ui.wrap_gradio_call(refresh_available_extensions, extra_outputs=[gr.update(), gr.update(), gr.update()]),
                ...
                install_extension_button.click(
                    fn=mo.ui.wrap_gradio_call(install_extension_from_index, extra_outputs=[gr.update(), gr.update()]),
                    inputs=[extension_to_install, hide_tags, sort_column, search_extensions_text],
                    outputs=[available_extensions_table, extensions_table, install_result],
                )

                search_extensions_text.change(
                    fn=mo.ui.wrap_gradio_call(search_extensions, extra_outputs=[gr.update()]),
                    inputs=[search_extensions_text, hide_tags, sort_column],
                    outputs=[available_extensions_table, install_result],
                )

                hide_tags.change(
                    fn=mo.ui.wrap_gradio_call(refresh_available_extensions_for_tags, extra_outputs=[gr.update()]),
            ...
            with gr.TabItem("Install from URL", id="install_from_url"):
                ...
                install_button.click(
                    fn=mo.ui.wrap_gradio_call(lambda *args: [gr.update(), *install_extension_from_url(*args)], extra_outputs=[gr.update(), gr.update()]),
            ...
            with gr.TabItem("Backup/Restore"):
                with gr.Row(elem_id="extensions_backup_top_row"):
                    ...
                    mo.ui.create_refresh_button(config_states_list, config_states.list_config_states, lambda: {"choices": ["Current"] + list(config_states.all_config_states.keys())}, "refresh_config_states")
