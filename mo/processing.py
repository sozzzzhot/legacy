...
import mo.sd_hijack
from mo import devices, prompt_parser, masking, sd_samplers, lowvram, generation_parameters_copypaste, extra_networks, sd_vae_approx, scripts, sd_samplers_common, sd_unet
from mo.sd_hijack import model_hijack
from mo.shared import opts, cmd_opts, state
import mo.shared as shared
import mo.paths as paths
import mo.face_restoration
import mo.images as images
import mo.styles
import mo.sd_models as sd_models
import mo.sd_vae as sd_vae
...
def process_images_inner(p: StableDiffusionProcessing) -> Processed:
    ...
    mo.sd_hijack.model_hijack.apply_circular(p.tiling)
    mo.sd_hijack.model_hijack.clear_comments()
        ...
        for n in range(p.n_iter):
            ...
            for i, x_sample in enumerate(x_samples_ddim):
                ...
                if p.restore_faces:
                    ...
                    x_sample = mo.face_restoration.restore_faces(x_sample)
                    devices.torch_gc()
