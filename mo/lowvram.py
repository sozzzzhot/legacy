...
def setup_for_low_vram(sd_model, use_medvram):
    ...
    def send_me_to_gpu(module, _):
        ...
        we add this as forward_pre_hook to a lot of mo and this way all but one of them will
        be in CPU
        """
        global module_in_gpu
    ...
    # remove several big mo: cond, first_stage, depth/embedder (if applicable), and unet from the model and then
    # send the model to GPU. Then put mo back. the mo will be in CPU.
