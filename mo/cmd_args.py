...
import json
import os
from mo.paths_internal import models_path, script_path, data_path, extensions_dir, extensions_builtin_dir, sd_default_config, sd_model_file  # noqa: F401
...
parser.add_argument("--embeddings-dir", type=str, default=os.path.join(data_path, 'beddings'), help="beddings directory for textual inversion (default: beddings)")
...
parser.add_argument("--use-cpu", nargs='+', help="use CPU as torch device for specified mo", default=[], type=str.lower)
