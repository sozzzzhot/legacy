...
def on_list_optimizers(callback):
    ...
    The function will be called with one argument, a list, and shall add objects of type mo.sd_hijack_optimizations.SdOptimization
    to it."""
...
def on_list_unets(callback):
    ...
    The function will be called with one argument, a list, and shall add objects of type mo.sd_unet.SdUnetOption to it."""
