...
from mo.shared import state
from mo import sd_samplers_common, prompt_parser, shared
import mo.models.diffusion.uni_pc
...
samplers_data_compvis = [
    ...
    sd_samplers_common.SamplerData('UniPC', lambda model: VanillaStableDiffusionSampler(mo.models.diffusion.uni_pc.UniPCSampler, model), [], {}),
]
...
class VanillaStableDiffusionSampler:
    def __init__(self, constructor, sd_model):
        ...
        self.is_unipc = isinstance(self.sampler, mo.models.diffusion.uni_pc.UniPCSampler)
